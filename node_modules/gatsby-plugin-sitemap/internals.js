...
var defaultOptions = {
  ...
  serialize: function serialize(_ref) {
    ...
    return allPages === null || allPages === void 0 ? void 0 : allPages.map(function (page) {
      ...
      return {
        url: "" + ((_ref2 = (_site$siteMetadata = site.siteMetadata) === null || _site$siteMetadata === void 0 ? void 0 : _site$siteMetadata.siteUrl) !== null && _ref2 !== void 0 ? _ref2 : "") + page.path,
        changefreq: "daily",
        priority: 0.7
      };
    });
...
function getNodes(results) {
  ...
  throw new Error("[gatsby-plugin-sitemap]: Plugin is unsure how to handle the results of your query, you'll need to write custom page filter and serilizer in your gatsby conig");
}